...
public class GalleryFragment extends BaseFragment {
    ...
    public   static String[] IMAGE_URLS = new String[]{
            "https://drive.google.com/uc?id=0B3XKCinfQKVTQlZjaTRZNmN3YzA"
            ...
            ,"https://drive.google.com/uc?id=0B3XKCinfQKVTbENKRGtSUFpfOUE"};
    ...
    private class ImageAdapter extends BaseAdapter
    {
        ...
        @Override
        public int getCount() {
           // TODO: 06-01-2016  no. of images 12 hardcoded
            return 12;
        }
        @Override
